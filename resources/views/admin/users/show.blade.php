        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800
                    ...
                    <img src="{{ $user->avatar_url }}"
                         ...
                         class="w-24 h-24 rounded-full object-cover
                                border-4 border-indigo-100 dark:border-indigo-900
                                mx-auto mb-4">
            ...
            <div class="md:col-span-2 space-y-5">
                ...
                <div class="bg-white dark:bg-gray-800
                    ...
                    @foreach([
                        ...
                        <div class="flex items-start justify-between gap-4">
                            <span class="text-xs text-gray-400 dark:text-gray-500 w-24 shrink-0">
                                {{ $label }}
                            </span>
                    ...
                    @if($user->bio)
                        <div>
                            <span class="text-xs text-gray-400 dark:text-gray-500 block mb-1">Bio</span>
                ...
                <div class="bg-white dark:bg-gray-800
                            ...
                            p-6">
                    <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-200
                               border-b border-gray-100 dark:border-gray-700 pb-2 mb-4">
                        Recent Posts
                    </h4>
